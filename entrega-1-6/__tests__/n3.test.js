describe('Nivell 3', () => {
    ...
    // Aquí hi ha només el testing del primer exercici Async/Await, perquè els errors del altres dos estan inclosos junt amb el testing del seu correcte funcionament en els arxius corresponents.
